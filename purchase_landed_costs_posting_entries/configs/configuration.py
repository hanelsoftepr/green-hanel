...
class NppPurchaseConfigSettings(models.TransientModel):
    ...
    def get_default_distribution_background(self, fields):
        value = eval(self.env.ref('purchase_landed_costs_posting_entries.npp_cost_distribution_config').value)
    ...
    def set_distribution_background(self):
        self.ensure_one()
        self.env.ref('purchase_landed_costs_posting_entries.npp_cost_distribution_config').write({
